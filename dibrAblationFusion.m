function [C_V] = dibrAblationFusion(layer_number, Znear, Zfar, C_L_O, C_R_O, Z_L_O, Z_R_O, K_L_O, K_R_O, K_V_O, Rt_L_O, Rt_R_O, Rt_V_O)
%     DIBR
%
%     layer_number = 3; % 分层数
...
%                     end
                    Z_Vs{i}(v,u,:) = (zvl + zvr) / 2;
                    C_Vs{i}(v,u,:) = (cvr + cvl) / 2;
                end
            end
        end
    end
