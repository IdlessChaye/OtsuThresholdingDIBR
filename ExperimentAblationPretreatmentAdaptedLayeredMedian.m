...
[C_V] = dibrAblationPretreatmentAdaptedLayeredMedian(layer_number, Znear, Zfar, C_L_O, C_R_O, D_L_O, D_R_O, K_L, K_R, K_V, Rt_L, Rt_R, Rt_V);
...
% save result
imwrite(C_V, ['ExAbPretreatmentAdaptedLayeredMedianBalletResult',sprintf(' psnr %f ssim %f',psnr, ssim) , '.png']);
% imwrite(C_V, ['ExAbPretreatmentAdaptedLayeredMedianBreakResult',sprintf(' psnr %f ssim %f',psnr, ssim) , '.png']);