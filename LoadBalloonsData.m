...
if is_dibr_do_refinement == false
    C_L_O_path = [prc_dir_name,'cam1_',frame_num,'.png'];
    C_R_O_path = [prc_dir_name,'cam5_',frame_num,'.png'];
    C_V_O_path = [pc_dir_name,'cam3_',frame_num,'.png'];
    D_L_O_path = [prd_dir_name,'cam1_',frame_num,'.png'];
    D_R_O_path = [prd_dir_name,'cam5_',frame_num,'.png'];
else
    C_L_O_path = [pc_dir_name,'cam1_',frame_num,'.png'];
    C_R_O_path = [pc_dir_name,'cam5_',frame_num,'.png'];
    C_V_O_path = [pc_dir_name,'cam3_',frame_num,'.png'];
    D_L_O_path = [pd_dir_name,'cam1_',frame_num,'.png'];
