...
if is_dibr_do_refinement == false
    ...
    C_L_O_path = [pc_dir_name,'cam5_.yuv',frame_num,'.png'];
    C_R_O_path = [pc_dir_name,'cam7_.yuv',frame_num,'.png'];
    C_V_O_path = [pc_dir_name,'cam6_.yuv',frame_num,'.png'];
    D_L_O_path = [pd_dir_name,'cam5_.yuv',frame_num,'.png'];
    D_R_O_path = [pd_dir_name,'cam7_.yuv',frame_num,'.png'];
end
