...
% save result
% imwrite(C_V, ['ExAbLayered',num2str(layer_number),'BalletResult',sprintf(' psnr %f ssim %f',psnr, ssim) , '.png']);
imwrite(C_V, ['ExAbLayered',num2str(layer_number),'BreakResult',sprintf(' psnr %f ssim %f',psnr, ssim) , '.png']);
